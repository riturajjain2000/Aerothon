  ...
  return (
    <div className={styles.container}>
      <div className={styles.innerBox}>
        <h1 className={styles.heading}>Buy A Part</h1>
        <InputControl
      ...
      <div className={styles.listBox}>
        <h4 className={styles.listHead}>Selling Request that you recieved</h4>
        ...
        <h4 className={styles.listHead}>Buy orders that you made</h4>
        <table className={styles.listContainer}>
          <thead>
            <tr>
              {columns.map((column) => (
